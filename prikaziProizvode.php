...
<nav class="navbar navbar-expand-lg navbar-light" id="navCont" style="height:100px; ">
  ...
  <div class="container pt">
    ...
    ?>
    <p id="p" style="color:white; font-size:35px ;padding-top:30px; padding-bottom:10px">Svi proizvodi:</p>
    <table class="table table-hover">
      ...
      <tbody style="color:white; font-size:20px ; font-weight: bold; background-color: #f4a9c9; opacity:85%">
        <?php
